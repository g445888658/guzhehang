...
namespace ValueHelper.RegeditHelper
{
    ...
    public class Regedit
    {
        ...
        public bool setValue(Regedit.keyType keytype, string key, string name, string values)
        {
            try
            {
        ...
        public string getValue(Regedit.keyType keytype, string key, string name)
        {
            try
            {
                RegistryKey rk = (RegistryKey)getRegistryKey(keytype);
        ...
        /// <param name="name">值名称</param>
        /// <returns>返回布尔值,指定操作是否成功</returns>
        public bool deleteValue(Regedit.keyType keytype, string key, string name)
        {
            try
            {
                RegistryKey rk = (RegistryKey)getRegistryKey(keytype);
        ...
        /// <returns>返回布尔值,指定操作是否成功</returns>
        public bool deleteSubKey(Regedit.keyType keytype, string key)
        {
            try
            {
                RegistryKey rk = (RegistryKey)getRegistryKey(keytype);
        ...
        public bool isExist(Regedit.keyType keytype, string key)
        {
            RegistryKey rk = (RegistryKey)getRegistryKey(keytype);
        ...
        public string[] getValues(Regedit.keyType keytype, string key)
        {
            RegistryKey rk = (RegistryKey)getRegistryKey(keytype);
        ...
        /// <param name="keytype">注册表基项枚举</param>
        /// <returns></returns>
        private object getRegistryKey(Regedit.keyType keytype)
        {
            RegistryKey rk = null;
